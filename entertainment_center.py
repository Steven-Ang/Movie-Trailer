...
goodfellas = media.Movie("Goodfellas",
                        "The story of Henry Hill and his life through " +
                        "the teen years into the years of mafia, " +
                        "covering his relationship with wife " +
                        "Karen Hill and his Mob" +
                        "partners Jimmy Conway and Tommy DeVitto in " +
...
halloween = media.Movie("Halloween",
                        "Fifteen years after murdering his sister " +
                        "on Halloween night 1963, Michael Myers " +
                        "escapes from a mental hospital and returns " +
                        "to the small town of Haddonfield to kill again.",
...
the_shining = media.Movie("The Shining",
                        "Jack Torrance accepts a caretaker job" +
                        "at the Overlook Hotel, where he, along " +
                        "with his wife Wendy and their son Danny," +
                        "must live isolated from the rest of the" +
                        "world for the winter. But they aren't " +
...
evangelion = media.Movie("The End of Evangelion",
                        """Concurrent theatrical ending of """ +
                        """the TV series "Shin Seiki Evangelion" (1995).""",
...
movies = [goodfellas, godfather, silence_of_the_lambs,
